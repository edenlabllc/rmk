	...
	return []*cli.Command{
		...
		},
		{
			...
			Subcommands: []*cli.Command{
				...
				{
					Name:         "fetch",
					Usage:        "Fetch charts from releases (Helmfile v1.1.x only)",
					Aliases:      []string{"f"},
					Before:       readInputSourceWithContext(gitSpec, conf, flags["releaseHelmfile"]),
					Flags:        flags["releaseHelmfile"],
					Category:     "release",
				...
				{
					Name:         "lint",
					Usage:        "Lint charts from releases (Helmfile v1.1.x only)",
					Aliases:      []string{"n"},
					Before:       readInputSourceWithContext(gitSpec, conf, flags["releaseHelmfile"]),
					Flags:        flags["releaseHelmfile"],
					Category:     "release",
				...
				{
					Name:         "show-dag",
					Usage:        "Show simplified DAGs of releases combined into groups (Helmfile v1.1.x only)",
					Aliases:      []string{"g"},
					Before:       readInputSourceWithContext(gitSpec, conf, flags["releaseHelmfile"]),
					Flags:        flags["releaseHelmfile"],
					Category:     "release",
